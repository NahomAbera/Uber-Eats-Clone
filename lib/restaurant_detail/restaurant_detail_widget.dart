...
class RestaurantDetailWidget extends StatefulWidget {
  const RestaurantDetailWidget({
    super.key,
    required this.restaurabtRef,
  });

  final DocumentReference? restaurabtRef;
...
class _RestaurantDetailWidgetState extends State<RestaurantDetailWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<RestaurantsRecord>(
      stream: RestaurantsRecord.getDocument(widget.restaurabtRef!),
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 0.0, 8.0),
                            child: Text(
                              'Open Until${restaurantDetailRestaurantsRecord.open}',
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
